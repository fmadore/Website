...
<style>
    ...
    .enhanced-header {
        background: radial-gradient(circle at 30% 30%, rgba(var(--color-primary-rgb), 0.06) 0%, var(--color-surface) 60%, var(--color-background) 100%);
    ...
    :global(html.dark) .enhanced-header {
        background: radial-gradient(circle at 30% 30%, rgba(var(--color-primary-rgb), 0.15) 0%, var(--color-dark-surface-alt) 60%, var(--color-dark-surface-deep) 100%);
