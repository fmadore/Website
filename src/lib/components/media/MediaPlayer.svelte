	...
	.audio-visualization {
		...
		&::before {
			...
			background:
				radial-gradient(
					circle at 25% 25%,
					rgba(var(--color-white-rgb), var(--opacity-5)) 0%,
					transparent 50%
				),
				radial-gradient(
					circle at 75% 75%,
					rgba(var(--color-highlight-rgb), var(--opacity-5)) 0%,
					transparent 50%
				),
				linear-gradient(
					45deg,
					transparent 30%,
					rgba(var(--color-accent-rgb), var(--opacity-very-low)) 70%
				);
			pointer-events: none;
		}
	...
	:global(html.dark) .audio-visualization {
		...
		&::before {
			background:
				radial-gradient(
					circle at 25% 25%,
					rgba(var(--color-accent-rgb), var(--opacity-5)) 0%,
					transparent 60%
				),
				radial-gradient(
					circle at 75% 75%,
					rgba(var(--color-highlight-rgb), var(--opacity-10)) 0%,
					transparent 60%
				),
				linear-gradient(
					45deg,
					transparent 30%,
					rgba(var(--color-primary-rgb), var(--opacity-very-low)) 70%
				);
		}
	}
