 ...
 * derive from them. Generated by scripts/generate-summaries.mjs
...
/**
 * The publication fields /cv prints: the bibliographic apparatus of an entry,
 * without the excerpts, tags, images and facet data the list pages carry.
 * Generated into `data/publications/cv.generated.ts` beside the summaries; a
 * CV section that starts reading another field fails the type-check until it
 * is added here and to CV_PUBLICATION_FIELDS.
 */
export type CvPublicationField =
	| 'id'
	| 'type'
	| 'title'
	| 'authors'
...
/** A publication as the CV reads it. */
export type CvPublication = Pick<PublicationSummary, CvPublicationField>;
