...
export const globalHeshmat: DigitalHumanitiesProject = {
	...
	description: `
		...
		<p>Heshmat was an internationally celebrated artist committed to an idea of "Art for All" (<em>Kunst für alle</em>). After training as a sculptor in Cairo, he travelled to Selb in Bavaria on a DAAD scholarship in 1957 to study porcelain, a medium that let him cast affordable multiples for a wide public. His monuments, reliefs, and sculptures still stand in parks, museums, and squares across several countries, and in 2000 he received Egypt's State Appreciation Award.</p>

		<h3>What you can explore</h3>
		<p>The map brings together 28 located works, most of them in Egypt and others in Germany, Poland, Sweden, Belgium, and the Netherlands, alongside eleven more that are documented but not yet located. In all it spans ten countries, and a "to be found" filter turns the gaps into an open call: visitors who recognise a Heshmat work in a public space are invited to report it.</p>
		<ul>
		...
		<ul>
			...
			<li><strong>Development</strong>: Dr Frédérick Madore</li>
