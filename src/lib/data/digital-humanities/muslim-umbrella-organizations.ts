	...
	embeddableContent: [
		{
			...
			description:
				'<p>Visualising the frequency with which terms related to Muslim umbrella organisations appear together in the corpus.</p>',
		...
		},
		{
			...
			description:
				'<p>Identifying latent topics and themes within the articles discussing these organisations.</p>',
			scrolling: 'yes',
			allowfullscreen: true,
			showTitle: true,
			containerClass: 'iframe-container-aspect iframe-container-aspect-16-9' // Reverted to aspect ratio
