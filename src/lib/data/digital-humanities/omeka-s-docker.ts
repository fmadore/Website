...
export const omekaSDocker: DigitalHumanitiesProject = {
	...
	description:
		...
		'<li><strong>Built for sustainability</strong> with standardised configurations that simplify long-term maintenance</li>' +
		'</ul>' +
