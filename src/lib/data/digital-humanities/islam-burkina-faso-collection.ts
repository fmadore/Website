...
export const islamBurkinaFasoCollection: DigitalHumanitiesProject = {
    ...
    award: "I won a 2023 Emerging Open Scholarship Award, sponsored by the Canadian Social Knowledge Institute (C-SKI) and its partners, for my work on the Islam Burkina Faso Collection.",
    reviews: [
        {
