...
export const iwac: DigitalHumanitiesProject = {
	...
	description: `
		...
		<h3>Seeing the collection</h3>
		<p>A second module turns the archive into interactive dashboards, built with <a href="https://echarts.apache.org/" target="_blank" rel="noopener noreferrer">ECharts<span class="sr-only"> (opens in new tab)</span></a> and <a href="https://maplibre.org/" target="_blank" rel="noopener noreferrer">MapLibre<span class="sr-only"> (opens in new tab)</span></a>. They fall into four kinds:</p>
		<ul>
		...
		<h3>Making it findable and citable</h3>
		...
		<h3>A bilingual, adaptable interface</h3>
