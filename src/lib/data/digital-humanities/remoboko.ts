...
export const remoboko: DigitalHumanitiesProject = {
    ...
    description: "<p><em>Remoboko</em> is a research group focused on exploring the intersections of religion, morality, and student life (particularly the concept of \"boko\" - Western education) in the context of West African higher education. The project incorporates interactive visualizations to present its findings and engage with a wider audience.</p>",
    ...
    embeddableContent: [
        {
            ...
            description: "<p>Interactive map showing the main locations related to the Remoboko project\\'s research on religious activism on university campuses, as detailed in the book <a href='/publications/religious-activism-campuses' target='_blank' rel='noopener noreferrer'>Religious Activism on University Campuses in West Africa</a>.</p>",
            scrolling: "yes",
        ...
        },
        {
            ...
            title: "Remoboko Activities Over Time",
