...
export const rechercheDocumentaireZotero: Communication = {
	id: 'recherche-documentaire-zotero',
	title:
		'La recherche documentaire en libre accès et la gestion de références bibliographiques avec Zotero',
