...
export const collectionIslamAfriqueOuest: Communication = {
	...
	title:
		"La Collection Islam Afrique de l'Ouest: nouvelles perspectives sur l'histoire des communautés musulmanes via la presse et les humanités numériques",
	authors: ['Frédérick Madore'],
	date: '25 March 2024',
	dateISO: '2024-03-25',
	year: 2024,
	conference:
		'Enjeux éthiques et juridiques au diapason des données de la recherche en études aréales',
