...
export const digitalHoardingOpenArchivesWarsaw: Communication = {
	...
	tags: ['Digital Humanities', 'AI', 'AI Agents', 'West Africa', 'Archives', 'IWAC', 'OCR', 'Large Language Models', 'Sentiment Analysis'],
	coordinates: {
