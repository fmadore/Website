...
export const associationsChretiennesIslamiquesCampus: Communication = {
	...
	title:
		"Les associations chrétiennes et islamiques sur les campus de l'Université d'Abomey-Calavi et de l'Université de Lomé depuis 1970: la laïcité à l'université face à l'activisme religieux",
