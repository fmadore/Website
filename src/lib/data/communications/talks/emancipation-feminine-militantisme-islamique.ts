...
export const emancipationFeminineMilitantismeIslamique: Communication = {
	...
	year: 2022,
	conference:
		"Atelier international Femmes africaines dans une société d'hommes: espaces contraints, habilité sociale et formes d'émancipation",
	...
	tags: ['Female Emancipation', 'Islamic Activism', 'West Africa', 'Gender Studies', 'Islam', 'Burkina Faso', "Côte d'Ivoire", 'Togo', 'Benin'],
