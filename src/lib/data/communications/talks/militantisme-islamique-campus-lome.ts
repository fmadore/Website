...
export const militantismeIslamiqueCampusLome: Communication = {
	...
	title:
		"Militantisme islamique sur le campus de l'Université de Lomé (Togo) depuis les années 1980: être musulman en contexte minoritaire, laïc et (semi-)autoritaire",
	...
	tags: ['Islamic Activism', 'Togo', 'Universities', 'Religious Minorities', 'Secularism', 'Islam', 'West Africa'],
