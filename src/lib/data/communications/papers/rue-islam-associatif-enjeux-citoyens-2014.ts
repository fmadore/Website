...
export const rueIslamAssociatifEnjeuxCitoyens: Communication = {
	...
	year: 2014,
	conference:
		"International Conference Le clos et l'ouvert. Acteurs religieux, acteurs sociaux et usages de la rue (Europe, Afrique, Asie, Amériques)",
