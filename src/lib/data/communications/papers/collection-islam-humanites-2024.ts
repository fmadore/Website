...
export const collectionIslamHumanites: Communication = {
	id: 'collection-islam-humanites-2024',
	title:
		"La Collection Islam Afrique de l'Ouest: enjeux éthiques et décolonisation des humanités numériques",
	...
	tags: ['MANSA', 'Digital Humanities', 'Decolonisation', 'Ethics', 'Islam', 'IWAC', 'West Africa'],
