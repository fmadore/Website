...
export const workshopReligionInHigherEducationalInstitutions2021: Communication = {
    ...
    authors: ["Abdoulaye Sounaye", "Frédérick Madore", "Vincent Favier", "Mahamadou Bello Adamou", "Adéjoké Rafiat Adétòrò"], 
    ...
    participants: [
        ...
        { name: "Frédérick Madore", role: "Convenor and Speaker", affiliation: "Leibniz-Zentrum Moderner Orient" },
        { name: "Vincent Favier", role: "Convenor and Speaker", affiliation: "Leibniz-Zentrum Moderner Orient" },
        { name: "Mahamadou Bello Adamou", role: "Convenor and Speaker", affiliation: "Université Abdou Moumouni, Niger" },
        { name: "Adéjoké Rafiat Adétòrò", role: "Convenor and Speaker", affiliation: "Université Laval, Canada" },
        { name: "Olubunmi  Olowookere", role: "Speaker", affiliation: "University of Ibadan, Nigeria" },
        { name: "Sekou Sala Timbely", role: "Speaker", affiliation: "Université Abdou Moumouni, Niger" },
        { name: "Ahmadou Hamage Issa", role: "Chair", affiliation: "Université Abdou Moumouni, Niger" },
        { name: "Gerd Spittler", role: "Discussant", affiliation: "University of Bayreuth, Germany" },
        { name: "June Temitope Gbadamosi", role: "Speaker", affiliation: "University of Ibadan, Nigeria" },
        { name: "Ibrahim Bachir Abdoulaye", role: "Chair", affiliation: "University of Bayreuth, Germany" },
        { name: "Dorothea E. Schulz", role: "Discussant", affiliation: "University of Münster, Germany" },
        { name: "Mara Leichtman", role: "Speaker", affiliation: "Michigan State University, USA" },
        { name: "Ameen Kasim", role: "Speaker", affiliation: "Islamic University College, Ghana" },
        { name: "Guy Bucumi", role: "Speaker", affiliation: "Université de Sherbrooke, Canada" },
        { name: "Mbaye Lo", role: "Speaker", affiliation: "Duke University, USA" },
        { name: "Karen Lauterbach", role: "Speaker", affiliation: "University of Copenhagen, Denmark" },
        { name: "Seyni Mamoudou Ibrahim", role: "Chair", affiliation: "University of Bayreuth, Germany" },
        { name: "Élodie Apard", role: "Discussant", affiliation: "Laboratoire d'Anthropologie Sociale (LAM), France" },
        { name: "Nadir Abdulhadi Nasidi", role: "Speaker", affiliation: "Ahmadu Bello University, Nigeria" },
        { name: "Youssoufou Bakayoko", role: "Speaker", affiliation: "Université Alassane Ouattara, Côte d'Ivoire" },
        { name: "Hamissou Rhissa Achaffert", role: "Chair", affiliation: "University of Bayreuth, Germany" },
        { name: "Benedikt Pontzen", role: "Discussant", affiliation: "Leibniz-Zentrum Moderner Orient" },
        { name: "Abdoulbaki Djibo", role: "Speaker", affiliation: "Université Abdou Moumouni, Niger" },
        { name: "Simbarashe Gukurume", role: "Speaker", affiliation: "Sol Plaatje University, South Africa" },
        { name: "Mamadou Yéro Baldé", role: "Speaker", affiliation: "Université Cheikh Anta Diop, Senegal" }
    ],
