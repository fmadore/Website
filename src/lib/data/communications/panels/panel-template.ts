...
export const panelTemplate: Communication = {
	...
	coordinates: {
		latitude: 52.52, // Example coordinates (Berlin)
		longitude: 13.405
	},
	papers: [
		// Array of papers presented in the panel
		{
			title: 'Paper Title 1',
			authors: [
		...
		{
			title: 'Paper Title 2',
			authors: [{ name: 'Author Name 2', affiliation: 'University or Institution 2' }],
			abstract: 'Abstract of the paper'
		}
	],
	participants: [
		// Additional participants (discussants, chairs, etc.)
		{
