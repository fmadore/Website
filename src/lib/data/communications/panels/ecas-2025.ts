    ...
    papers: [
        {
            ...
            authors: [
                { name: "Harris Ashleigh", affiliation: "Uppsala University" }
            ],
        ...
        {
            title: "Preserving African Literature: Digital Pathways for Contextual Interpretation and Epistemic Frameworks",
            authors: [
                { name: "Augustine A. Farinola", affiliation: "University of Alberta" }
            ],
            abstract: "In a world where digital platforms increasingly shape access to global knowledge, African literary works often remain underrepresented or misunderstood due to the lack of context around their linguistic, cultural, and philosophical foundations. Africanpedia is a comprehensive digital archive that seeks to address this gap by preserving and presenting African literature within its unique epistemic and cultural frameworks. The project is rooted in the belief that African literary heritage can only be fully appreciated through a lens that respects its multilingualism, historical depth, and the philosophical traditions it embodies. African literary works have long been shaped by both native and colonial influences. Many African authors write in colonial languages like English, French, or Portuguese, but their work is deeply informed by African languages, epistemologies, and histories. Africanpedia offers a structured platform that allows scholars and readers to explore these interwoven dynamics, revealing the rich cultural and political backgrounds that shape the literary output of African writers. The platform's goal is to provide users with a contextualized experience of African literature. It features detailed historical accounts of African empires and communities, multilingual perspectives on African texts, and tools for understanding the epistemic frameworks embedded within the works. By fostering a deeper understanding of the sociopolitical and linguistic elements of African literature, its users to engage with these texts on a more meaningful level. It's designed not only for scholars but also for general readers interested in African culture."
        },
        {
            title: "Taking the ESCALATOR from Humanities to Digital Humanities",
            authors: [
                { name: "Menno van Zaanen", affiliation: "South African Centre for Digital Language Resources" },
                { name: "Jessica Mabaso", affiliation: "South African Centre for Digital Language Resources" }
            ],
        ...
        },
        {
            ...
            authors: [
                { name: "Albrecht Hofheinz", affiliation: "University of Oslo" }
            ],
        ...
        },
        {
            ...
            authors: [
                { name: "Ademide Adelusi-Adeluyi", affiliation: "Howard University" }
            ],
        ...
        },
        {
            ...
            authors: [
                { name: "Susan Elizabeth Gagliardi", affiliation: "Emory University" }
            ],
