...
export const religiousActivismCampuses: Activity = {
	...
	year: 2025,
	description:
		'New book publication based on research conducted at Leibniz-Zentrum Moderner Orient since 2021.',
	content: `
    ...
    `,
	tags: ['Publication', 'Remoboko', 'Togo', 'Benin', 'Religious Activism', 'Islam', 'Open Access', 'Book Launch'],
