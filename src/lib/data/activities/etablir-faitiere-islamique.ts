...
export const etablirFaitiereIslamique: Activity = {
	...
	title:
		"Établir une faîtière islamique à l'échelle nationale: le cas de 4 pays d'Afrique de l'Ouest francophone",
	dateISO: activityDateISO,
	date: formatDisplayDate(activityDateISO),
	year: 2025,
	description:
		'Comparative analysis of national Islamic umbrella organizations in four West African countries.',
	content: `
    ...
    `,
	tags: ['Workshop', 'Benin', 'Burkina Faso', "Côte d'Ivoire", 'Togo', 'Islam', 'West Africa'],
	panelType: 'workshop',
	heroImage: {
