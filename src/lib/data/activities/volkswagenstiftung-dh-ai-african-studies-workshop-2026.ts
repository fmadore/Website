...
export const activity: Activity = {
  ...
  content: `
    ...
    <p>Instead of giving presentations, participants will work together to write a <strong>position paper</strong> containing actionable recommendations for research funders, universities, technology developers, and policymakers. The aim is to promote the <strong>ethical and equitable advancement</strong> of DH and AI in African Studies.</p>

    <p>If you work at this intersection, what examples, tools or considerations should we be aware of? <strong>We welcome your suggestions!</strong></p>
  `,
