...
export const religiosityUniversityCampuses: Publication = {
    ...
    tags: ["religion", "education", "Africa", "university", "religious studies", "anthropology", "sociology", "history", "edited volume", "student activism"],
    image: "images/publications/religiosity-university-campuses.jpg",
    heroImage: {
        src: "images/publications/religiosity-university-campuses-hero.jpg",
