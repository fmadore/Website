...
export const introductionReligiosityUniversityCampuses: Publication = {
	...
	tags: ['Africa', 'University Campuses', 'Religiosity', 'Higher Education', 'Religious Movements', 'Religion'],
