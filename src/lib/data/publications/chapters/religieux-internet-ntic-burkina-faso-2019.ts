...
export const religieuxInternetNTICBurkinaFaso: Publication = {
    ...
    citedBy: [
        ...
        {
            authors: ["Alexis Abodohoui", "Maxime Domanou", "Falylath Babah Daouda", "Janvier Egah"],
            year: 2020,
            title: "Influence du marketing digital sur la performance commerciale des entreprises agroalimentaires des communes du Borgou",
            source: "Annales de Sciences de Gestion de l'UAC 2, no. 1 (2020): 77-108."
        },
        {
            authors: ["Maxime Mahougnon Eminence Domanou", "Alexis Abodohoui", "Francine Tokpo", "Jacob Yabi"],
            year: 2021,
            title: "Influence du marketing digital sur la participation des entreprises agroalimentaires des communes du Borgou aux chaînes de valeur agricoles mondiales",
            source: "Revue africaine de management 6, no. 3 (6 June 2021): 139-66.",
            url: "https://doi.org/10.48424/IMIST.PRSM/ram-v6i3.22534"
        },
        {
            authors: ["Katrin Langewiesche"],
            year: 2021,
            title: "A Muslim Minority and the Use of Media: Charismatic Aesthetics of the Ahmadiyya in West Africa",
            source: "Islamic Africa 12, no. 2 (2021): 211-39.",
            url: "https://doi.org/10.1163/21540993-01202006"
        },
        {
            authors: ["Kassoum Drame"],
            year: 2021,
