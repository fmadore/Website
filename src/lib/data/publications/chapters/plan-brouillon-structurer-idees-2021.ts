...
export const planBrouillonStructurerIdees: Publication = {
    ...
    language: "French",
    abstract: "Ce chapitre fournit quelques conseils afin de vous préparer adéquatement à la rédaction du brouillon à travers trois étapes : la planification avec l’élaboration d’un plan structuré et détaillé contenant les idées principales de l’argumentation et les références soutenant les affirmations; la rédaction d’une première version du texte (le brouillon); et enfin, la révision du texte afin de produire une version remaniée plus aboutie.",
    tags: ["research methodology", "academic writing", "writer's block", "research planning", "decolonial approach"],
    url: "https://scienceetbiencommun.pressbooks.pub/projetthese/chapter/faire-une-table-des-matieres/",
    image: "images/publications/plan-brouillon-2021.jpg",
    project: "Other"
}; 