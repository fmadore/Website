...
export const acteursReligieuxNumerique: Publication = {
	...
	tableOfContents: [
		...
		{
			title:
				"Le Sénégal à l'heure des médias numériques confessionnels. Le Hizbut-Tarqiyyah et son site Internet, comme reflets de nouveaux lieux de culte virtuels",
		...
		{
			title:
				"De l'utilisation d'Internet en République démocratique du Congo. Un outil de mobilisation politique et religieuse",
