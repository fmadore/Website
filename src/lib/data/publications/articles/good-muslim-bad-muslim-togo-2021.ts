...
export const goodMuslimBadMuslimTogo: Publication = {
    ...
    citedBy: [
        ...
        {
            authors: ["Kossi Eden Andrews Adandjesso"],
            year: 2023,
            title: "L'impossible alternance politique au Togo de 1990 à 2020 : institutions, idées et intérêts dans la reproduction du pouvoir",
        ...
        },
        {
            ...
            year: 2021,
            title: "Studying Muslim Minorities in Subsaharan Africa: Preliminary Remarks",
            source: "Islamic Africa 12, no. 2 (2021): 173-85",
            url: "https://doi.org/10.1163/21540993-01202008"
        },
        {
            authors: ["Didik Hariyanto", "Ferry Adhi Dharma", "Isnaini Rodiyah"],
            year: 2025,
        ...
        },
        {
            ...
            year: 2024,
            title: "Sahel, Sahara and Savannah (Sahvara): Responses to Uneven Development in West Africa",
            source: "International Journal of African Studies 4, no. 1 (2024): 54-86",
            url: "https://doi.org/10.51483/IJAFRS.4.1.2024.54-86"
        },
        {
        ...
        },
        {
            ...
            source: "In L'interculturel dans l'espace francophone postcolonial : l'éducation et la formation à l'épreuve des crises, edited by Rania Hanafi, Jean-François Bruneaud, and Mamadou Bouna Timera. Paris: L'Harmattan, 2025"
        },
        {
            authors: ["Marius Kothor", "Benjamin N. Lawrance"],
            year: 2023,
            title: "The History of Togo and the Togolese People",
            source: "In Oxford Research Encyclopedia of African History. Oxford: Oxford University Press, 2023",
            url: "https://doi.org/10.1093/acrefore/9780190277734.013.714"
        }
    ]
}; 