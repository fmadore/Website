...
export const francophoneMuslimIntellectualsBurkinaFaso: Publication = {
	...
	citedBy: [
		...
		{
			authors: ['Aminah Azis', 'Mustaqim Pabbajah', 'Hannani', 'M. Taufiq Hidayat Pabbajah'],
			year: 2024,
			title:
				'The Authority of Khalwatiyah Tariqa of Sheikh Yusuf Al-Makassary on Fostering Religious Moderation in South Sulawesi',
			source: 'International Journal of Islamic Thought 25 (2024): 15-26',
			url: 'https://doi.org/10.24035/ijit.25.2024.282'
		},
		{
		...
		},
		{
			...
			source: 'Sociologus 70, no. 2 (2020): 159-79',
			url: 'https://doi.org/10.3790/soc.70.2.159'
		},
		{
			authors: ['Riswandi Riswandi'],
			year: 2024,
			title:
				'Sipakalebbi sebagai Model Komunikasi Antarbudaya Etnis Bugis dan Etnis Konjo di Sulawesi Selatan, Indonesia',
			source: 'Al-Adabiya: Jurnal Kebudayaan dan Keagamaan 19, no. 2 (2024): 175-96',
		...
		},
		{
			...
			source:
				'In The Oxford Handbook of the African Sahel, edited by Leonardo A. Villalón. Oxford: Oxford University Press, 2021',
			url: 'https://doi.org/10.1093/oxfordhb/9780198816959.013.26'
		},
		{
			authors: ['Lamin Keita'],
			year: 2024,
			title: 'The Politics of Community Resilience to Armed Jihadism in West Africa',
			source: 'PhD dissertation, Northwestern University, 2024',
		...
		},
		{
			...
			source:
				'In The Oxford Handbook of the African Sahel, edited by Leonardo A. Villalón, 605-21. Oxford: Oxford University Press, 2021',
			url: 'https://doi.org/10.1093/oxfordhb/9780198816959.013.49'
		},
		{
			authors: ['Barbara Faccenda'],
			year: 2023,
			title:
