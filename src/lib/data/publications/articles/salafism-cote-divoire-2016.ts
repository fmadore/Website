...
export const salafismCoteDIvoire: Publication = {
    ...
    citedBy: [
        ...
        },
        {
            authors: ["Issouf Binaté"],
            year: 2019,
            title: "La présence turque en Côte d'Ivoire contemporaine : entreprise transnationale au service de l'éducation, l'humanitaire et l'islam en Afrique de l'ouest",
            source: "Canadian Journal of African Studies / Revue canadienne des études africaines 53, no. 2 (2019): 215-33",
            url: "https://doi.org/10.1080/00083968.2019.1597743"
        },
        {
            authors: ["Marie Miran-Guyon"],
            year: 2017,
            title: "Société musulmane et régime Ouattara en Côte d'Ivoire : des affinités électives en demi-teinte",
            source: "Afrique contemporaine, no. 263-264 (2017): 249-54",
            url: "https://doi.org/10.3917/afco.263.0249"
        },
        {
        ...
        {
            authors: ["Mohammad Maulana Iqbal"],
            year: 2023,
            title: "THE LIFE OF THE NIQAB AND SIRWAL; Phenomenological Study of Family Power Relations to Stigma",
            source: "Jurnal Sosiologi Agama 17, no. 1 (2023): 33-48",
            url: "https://doi.org/10.14421/jsa.2023.171-03"
        },
        {
        ...
        },
        {
            ...
            year: 2021,
            title: "African Salafism",
            source: "In Routledge Handbook of Islam in Africa, edited by Terje Østebø, 173-87. London: Routledge, 2021",
            url: "https://doi.org/10.4324/9780367144241-16"
        },
        {
            authors: ["Joseph Hellweg"],
            year: 2019,
            title: "Songs from the Hunters' Qur'an: Dozo Music, Textuality, and Islam in Northwestern Côte d'Ivoire, from the Repertoire of Dramane Coulibaly",
            source: "African Studies Review 62, no. 1 (2019): 120-47",
            url: "https://doi.org/10.1017/asr.2018.142"
        },
        {
        ...
        },
        {
            ...
            year: 2023,
            title: "Keeping Jihadists Out of Northern Côte d'Ivoire",
            source: "Africa Briefing. Brussels: International Crisis Group, 11 August 2023",
            url: "https://www.crisisgroup.org/africa/west-africa/cote-divoire/b192-keeping-jihadists-out-northern-cote-divoire"
        },
        {
            authors: ["Dinah Hannaford"],
            year: 2023,
            title: "Aid and the Help: International Development and the Transnational Extraction of Care",
            source: "Stanford: Stanford University Press, 2023",
            url: "https://www.sup.org/books/sociology/aid-and-help"
        },
        {
            authors: ["Stavros Sindakis", "Saloome Showkat"],
            year: 2024,
