...
export const hadjCoteDIvoire: Publication = {
    ...
    citedBy: [
        ...
        },
        {
            ...
            year: 2021,
            title: "Paradigme de l'entrepreneur dans le management et la communication des entreprises religieuses en Côte d'Ivoire",
        ...
        },
        {
            ...
            year: 2021,
            title: "The Politics of the Hajj Organisation in Senegal: Security, Legitimation and Clientelism",
        ...
        },
        {
            ...
            year: 2019,
            title: "Organisations islamiques nigérianes en Côte d'Ivoire : les trajectoires concurrentielles de NASFAT et NAMFAT",
        ...
        },
        {
            ...
            source: "In The Politics of the Hajj from a Comparative Perspective: States, Entrepreneurs, and Pilgrims, edited by Muriel Gomez-Perez, Cédric Jourde, and Marie Brossier, 1-25. Cham: Palgrave Macmillan, 2025",
            url: "https://doi.org/10.1007/978-3-031-65349-0_1"
        },
        {
            authors: ["Kouamé Félix Grodji", "Bony Guiblehon"],
            year: 2024,
            title: "Engager les religieux et les chefs traditionnels permet-il de réconcilier après une crise sociopolitique violente? Une réflexion à partir de l'expérience ivoirienne",
        ...
        },
        {
            ...
            year: 2022,
            title: "Le pluralisme religieux sous le prisme du régime juridique de la laïcité dans les États d'Afrique noire francophone : Cameroun, Côte d'Ivoire, Gabon et Sénégal",
        ...
        },
        {
            authors: ["Gianni Dore"],
            year: 2021,
            title: "Capi locali e colonialismo in Eritrea : biografie di un potere subordinato (1937-1941)",
