...
export const islamBurkinaCollection: Publication = {
    ...
    citedBy: [
        ...
        },
        {
            ...
            year: 2023,
            title: "Developing Crosslingual Ontologies in WissKI: Transcontinental Research Collaboration in the Africa Multiple Cluster of Excellence",
        ...
        },
        {
            ...
            year: 2024,
            title: "De la cassette au fichier numérique : enjeux de l'archivage, du partage et de la restitution des archives orales enregistrées au Niger",
