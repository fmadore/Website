...
<div class="prose">
    ...
    <a href="/files/cv.pdf" class="cv-button">CV</a>
    
    <div class="activity-section">
        <h2 class="activity-section-title">Latest activities</h2>
        ...
        <a href="/activities" class="see-more">
            See more
        </a>
