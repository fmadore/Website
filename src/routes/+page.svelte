			...
			<ContentBody variant="default" glassEffect="glass-card">
				{#snippet children()}
					...
					<p>
						...
						representations of Islam and trace the changing relationships between Muslim communities
						and state authorities. Data visualisation transforms these analyses into accessible narratives
					...
					<p>
						...
						and Muslim student associations in the 1970s and their subsequent reshaping of
						university life in Lomé and Abomey-Calavi, challenging the prevailing secular
						ideologies. I am also the author of
						...
						<ItemReference id="religiosity-university-campuses" />. In addition, I have co-edited
						two special journal issues: "Muslim Minorities in Africa, Part 1" <ItemReference
						...
						<a href="{base}/publications" data-sveltekit-preload-data>research</a> has been published
						in eleven peer-reviewed journals and six edited volumes.
					</p>
					...
					<p>
						...
						computational techniques to advance understanding of Muslim societies in Francophone
						West Africa.
					</p>
				{/snippet}
			</ContentBody>
