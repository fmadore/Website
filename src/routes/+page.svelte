...
<div class="container max-w-7xl">
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
		<div
			class="md:col-span-2 bg-default rounded-lg p-8 shadow-sm border border-default transition-all duration-300 hover:shadow-md hover:-translate-y-1"
		>
		...
		<aside
			class="bg-default rounded-lg p-6 shadow-sm border border-default transition-all duration-300 hover:shadow-md hover:-translate-y-1"
		>
