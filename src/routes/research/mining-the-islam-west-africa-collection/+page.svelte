    ...
    <div class="grid">
        <div class="main-content">
            ...
            <div class="project-content">
                ...
                <p>Network analysis maps the contours of an "Islamic Francophonie", visualising the links between authors, publishers, NGOs and state institutions. These visualisations show how French became a strategic language for Islamic debate among urban elites, and how regionally rooted networks engaged with - rather than merely echoed - broader Arab-Islamic currents.</p>
                
                <p>By integrating these computational insights with ethnographic fieldwork and close textual study, the project offers a composite portrait of Islamic thought in Francophone West Africa - one that situates religious ideas within their material, linguistic and political ecologies. In doing so, it advances the intellectual history of the region and proposes a new approach to the study of print publics at the intersection of religion, morality, and civic life.</p>
