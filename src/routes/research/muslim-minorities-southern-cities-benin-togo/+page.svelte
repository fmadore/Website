		...
		<div class="main-content">
			...
			<div class="project-content">
				<p>
					...
					Muslim minorities in Cotonou, Porto-Novo and Lomé. Combining archival work with long-term
					ethnography, it traces their trajectories from the 1960s to the present to see how living
					as an internally diverse minority in a Christian-majority environment shapes their
					religious practices, civic engagement and claims to citizenship.
				</p>
				<p>
					One consistent finding is how elites instrumentalise fear of extremism. In Togo, political
					leaders have branded opposition figures "Salafi" to legitimise arrests, while senior
					Muslim leaders sometimes recycle the same label to sideline rivals within their own
					organisations. These manoeuvres show that talk of radicalisation often reflects local
					power struggles rather than imported jihadist ideologies <ItemReference
						id="lutte-terrorisme-salafisme-benin-togo-2022"
					/>.
				</p>
				<p>
					During the 2017-18 protests in Lomé, the regime drew a sharp line between "good" and "bad"
					Muslims in order to fracture an opposition coalition led by Muslim politicians <ItemReference
						id="good-muslim-bad-muslim-togo-2021"
					/>. In Benin, controversy erupted when a Cotonou imam successfully entered parliament in
					2019; the episode exposed generational divides over who can legitimately speak for Muslims
					in a minority context <ItemReference id="beninese-imam-election-2022" />.
				</p>
				<p>
					The project also explored the plurality of ways in which Muslim youth and women make sense
					of their religious identity in their everyday lives, beyond established analytical
					categories (Sufi, reformist, Salafi). Their fluid practices echo the argument of "Repenser
					la catégorisation religieuse à partir du Bénin, terre du vodun" <ItemReference
						id="repenser-categorisation-religieuse-benin-2026"
					/> that official statistics overstate the advance of monotheism and overlook the hybrid, overlapping
					rituals that many believers quietly practice.
				</p>
				<p>
					...
					security tropes, the project offers a fuller picture of how southern Beninese and Togolese
					Muslims negotiate faith, power and belonging in one of West Africa's most religiously
					plural zones.
				</p>
			</div>
		</div>
