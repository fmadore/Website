			...
			<div class="scroll-reveal">
				...
				{#snippet children()}
					...
					<p>
						...
						>, using its 28-million-word corpus as a testing ground for the limits of AI in historical research. For instance, I use AI sentiment analysis to apply "distant reading" techniques and investigate how Islam and Muslims are represented in Francophone West African newspapers, with results visualised in an <a
							href="https://fmadore.github.io/IWAC-sentiment-analysis/"
							target="_blank"
							rel="noopener noreferrer">interactive dashboard</a>. This research ultimately posits AI not as a replacement for human judgement, but as a pragmatic and scalable solution for processing the vast amount of born-digital material that will define the future of African history.
					</p>
