<script lang="ts">
	...
	/*
	 * Organiser-role schema.org Event graph for the two 2026 workshops I'm
	 * co-organising. Surfaces them to Google's event results and makes the
	 * organiser attribution machine-readable.
	 */
	...
	const organisedWorkshopsJsonLd = JSON.stringify({
